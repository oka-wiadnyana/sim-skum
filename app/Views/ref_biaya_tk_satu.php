...
<div class="d-flex justify-content-center">
  <div class="col-md-6 bg-white p-2 shadow">
    ...
    <div class="mt-2">
      ...
      <form action="<?= base_url('skum/simpan_ref_biaya_tk_satu'); ?>" method="post">
        <fieldset>
          ...
          <div class="form-group">
            <label for="">Panggilan Tidak Diketahui</label>
            <input name="unknown" id="" class="form-control" value="<?= ($data) ? number_format($data['panggilan_tidak_diketahui'], 0, ',', '.') : 0; ?>"></input>
          </div>
