    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex">
          ...
          <div class="col-1">:</div>
          <div class="col-3 pemberitahuan-kasasi" id=''>0</div>
        </div>
        <div class="d-flex">
          <div class="col-8">PNBP Relas Pemberitahuan Pernyataan Kasasi</div>
          <div class="col-1">:</div>
          <div class="col-3 pnbp-pemberitahuan-kasasi" id=''>0</div>
        </div>
        <div class="d-flex">
        ...
        <div class="d-flex">
          ...
          <div class="col-1">:</div>
          <div class="col-3 biaya-kasasi" id=''>0</div>
        </div>
...
<script>
  $(document).ready(function() {
    ...
    $('.biaya-kasasi').html(new Intl.NumberFormat("id-ID").format(biaya_kasasi));
    ...
    $('#tergugat').on('change', '.kelurahan-select', function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('.penyerahan-akta').html(new Intl.NumberFormat("id-ID").format(pnbp_penyerahan_akta));
          $('.pemberitahuan-kasasi').html(new Intl.NumberFormat("id-ID").format(sum_pemberitahuan_pernyataan));
          $('.pnbp-pemberitahuan-kasasi').html(new Intl.NumberFormat("id-ID").format(pnbp_pemberitahuan_pernyataan));
    ...
    $('.skum-wrapper').on('click', '.simpan-skum', function(e) {
      ...
      $.ajax({
        type: "post",
        url: "<?= base_url('skum/insert_skum_kasasi'); ?>",
        data: {
        ...
        success: function(response) {
          ...
          if (response.msg == 'success') {
            ...
            $(location).attr('href', '<?= base_url('skum/v_main_skum_kasasi'); ?>')
