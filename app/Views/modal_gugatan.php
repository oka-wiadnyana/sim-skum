    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Gugatan</h5>
                        ...
                        <div class="card mt-2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex p-2">
                                    <small class="">Ditambah dengan biaya penggandaan sebesar Rp500 perlembar dikalikan sejumlah para pihak dan Majelis Hakim</small>
                                </div>
