...
<div class="d-flex justify-content-center">
  <div class="col-md-6 bg-white p-2 shadow">
    ...
    <div class="mt-2">
      ...
      <form action="<?= base_url('skum/simpan_ref_biaya_tk_kasasi'); ?>" method="post">
        <fieldset>
          ...
          <div class="form-group">
            <label for="">Biaya Kasasi</label>
            <input name="biaya_kasasi" id="" class="form-control" value="<?= ($data) ? number_format($data['biaya_kasasi'], 0, ',', '.') : 0; ?>"></input>
          </div>
          <div class="form-group">
